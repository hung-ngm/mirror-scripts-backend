...
def create_chat_completion(
    ...
    Args:
        ...
        model (str, optional): The model to use for the chat completion. Defaults to None.
        temperature (float, optional): The temperature to use for the chat completion. Defaults to CFG.temperature.
...
async def stream_response(
    model, messages, temperature, max_tokens, websocket
):
    paragraph = ""
    response = ""
...
def choose_agent(task: str) -> str:
    ...
    try:
        ...
        print(f"{Fore.RED}Error in chose_agent: {e}{Style.RESET_ALL}")
